<template>
  <div class="player" v-show="playlist.length>0">
    ...
    >
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="middle" @touchstart="middleTouchStart" @touchmove="middleTouchMove" @touchend="middleTouchEnd">
          ...
          <scroll class="middle-r" ref="lyricList" :scrollData="currentLyric && currentLyric.lines">
    ...
    <audio :src="currentSong.url" ref="audio" @canplay="ready" @error="error" @timeupdate="updateTime" @ended="songEnd"></audio>
  </div>
</template>
